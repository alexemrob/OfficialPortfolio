  ...
  return (
    ...
    >
      <div className="flex flex-col items-center justify-center md:flex-row-reverse md:w-10/12 md:justify-between">
        ...
        <div className="font-dosis w-full md:w-3/5 text-center ">
          <h2
          ...
          <ScrollLink to="mywork" smooth={true}>
            <button
              className={` animate-bounce bg-blue-500 px-10 py-3 text-lg uppercase text-white rounded-lg mt-10 hover:bg-red-300 transform  ${
                animated ? 'translate-y-0' : styleTranslate
              } ${transition(3500)}`}
            >
